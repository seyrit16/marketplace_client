...
const PickupPointSignIn: React.FC = () => {
    ...
    return (
        <div className="signin-pickup-point container mx-auto p-4 max-w-md">
            {authMode === "code" && step === 1 && (
                <div className="step" onKeyDown={handleOnKeyDown}>
                    ...
                    <a role={"button"} onClick={()=>{navigate("/pp/sign_up")}}>
                        Нет аккаунта?
                    </a>
                </div>
            )}
...
export default PickupPointSignIn;